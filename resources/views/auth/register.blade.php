...
<head>
    ...
    <title>Tasky App | Register</title>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('pages:auth:register:action') }}" method="POST">
                ...
                <div>
                    <label for="sub_domain" class="block text-sm font-medium leading-6 text-gray-900">
                        Sub Domain
                    </label>
                    <div class="mt-2">
                        <div class="flex items-center justify-center gap-2">
                            <input id="sub_domain" name="sub_domain" type="text" autocomplete="sub_domain" required
                                class="block w-full px-1.5 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
